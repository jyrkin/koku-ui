...
public class Log {
  ...
  private LogServicePortType getLogService() {
    ...
    LogServiceFactory logServiceFactory = new LogServiceFactory(Constants.LOK_SERVICE_USER_ID, Constants.LOK_SERVICE_PASSWORD, Constants.LOK_ENDPOINT);
  ...
  private AuditInfoType getLogAuditInfo(String userId) {
    ...
    logAuditInfoType.setComponent(Constants.COMPONENT_KKS);

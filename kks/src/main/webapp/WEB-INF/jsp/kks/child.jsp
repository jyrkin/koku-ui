			...
			<div class="kks-table">
				...
				<table class="portlet-table-body kks-print" width="100%" border="0">
					<tr>
						...
						<c:if test="${ sessionScope.municipal_employee }">
							<th><spring:message code="ui.kks.messages" /></th>
							<th><spring:message code="ui.kks.actions" /></th>
						</c:if>
						...
						<c:forEach var="collection" items="${collections}">
							...
							<c:if
								...
								<tr>
									...
									<c:if test="${ sessionScope.municipal_employee }">
										<td><form:form name="sendForm-${collection.id}"
												method="post" action="${sendMailURL}">
												<input type="hidden" id="collectionName"
													name="collectionName" value="${ collection.name }" />
												<input type="submit" class="portlet-form-button"
													value="<spring:message code="ui.kks.send.button"/>">
											</form:form></td>
										<td><form:form name="deleteForm-${collection.id}"
												method="post" action="${deleteCollectionURL}">
									...
									<td><c:out value="${collection.modifierFullName}" /> <c:out
												...
												<c:when test="${collection.state.active}">
							                        ...
							                        <portlet:actionURL>
														...
														<c:if test="${not empty selected}">
															...
															<spring:message code="ui.kks.lock" />
													</a>
													</span>
												</c:when>
												<c:otherwise>
													<c:if test="${ not collection.versioned }">
	                                                    ...
	                                                    <portlet:actionURL>
															...
															<c:if test="${not empty selected}">
																...
																<spring:message code="ui.kks.activate" />
														</a>
														</span>
													</c:if>
				...
				href="
					...
					<div class="kks-link">
                        ...
                        <portlet:actionURL>
							...
							<spring:message code="ui.kks.healthcare" />
						</a>
					</div>
					...
					<div class="kks-link">
                        ...
                        <portlet:actionURL>
							...
							<spring:message code="ui.kks.measurement" />
						</a>
					</div>
					<div class="kks-link">
						<a
                        ...
                        <portlet:actionURL>
							...
							<spring:message code="ui.kks.child.rase" />
						</a>
					</div>
					<div class="kks-link">
						<a
                        ...
                        <portlet:actionURL>
							...
							<spring:message code="ui.kks.support.needs" />
						</a>
					</div>
					...
					<c:if test="${ sessionScope.municipal_employee }">
                        ...
                        <portlet:actionURL>
							...
							<c:if test="${not empty selected}">
								...
								<spring:message code="ui.kks.feedback" />
						</a>
						</span>
						<br />
                        ...
                        <portlet:actionURL>
							...
							<c:if test="${not empty selected}">
								...
								<spring:message code="ui.kks.wishes" />
						</a>
						</span>
						<br />
					...
					<div class="collection">
						<c:if test="${ sessionScope.municipal_employee }">
							<a class="create"> <spring:message code="ui.kks.new.contract" /><span
								class="kks-close"><spring:message code="ui.kks.hide" />
							</span>
							</a>
							<div class="kks-fields" style="display: none;">
								...
								<form:form name="creationForm" commandName="creation"
									...
									<span class="portlet-form-field"> <form:select
											id="kks.select" path="field" onchange="insertSelection();">

											<form:option class="portlet-form-input-field" value=""
												label="" />
									...
									<span class="portlet-form-field"><form:input
											maxlength="250" id="kks.name" path="name" size="70" /> </span>


									<span class="kks-right"> <input type="submit"
										class="portlet-form-button"
										value="<spring:message code="ui.kks.contract.save"/>">
									</span>
								</form:form>

...
public final class Constants {
	...
	public static final String ATTR_NAVI_POSITION							= "naviPosition";
	...
	public static final String TASK_TYPE_MESSAGE_ARCHIVE_INBOX				= "msg_archive_inbox";
	public static final String TASK_TYPE_MESSAGE_ARCHIVE_OUTBOX				= "msg_archive_outbox";
	...
	public static final String TASK_TYPE_APPLICATION_PROSESSED_BROWSE		= "application_processed_browse";		// Asiointipalvluet - Käsitellyt hakemukset
	...
	public static final String PREF_EXCLUDE_FILTER							= "excludeFilter";

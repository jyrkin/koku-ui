...
public class TaskManagementService {
	...
	public List<TaskMetadata> getAvailableTasks(String participantToken,
		...
		try {
			...
			throw new IntalioException("getAvailableTasks - TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"' InvalidParticipantTokenFault_Exception: ", e);
		} catch (InvalidInputMessageFault_Exception e2) {
			throw new IntalioException("getAvailableTasks - TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"' InvalidInputMessageFault_Exception: ", e2);
		} catch (Exception e1) {
			throw new IntalioException("getAvailableTasks - TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"' Intalio exception: " + e1.getMessage(), e1);
		}
		return taskList;
	}
	...
	public String getTotalTasksNumber(String participantToken, String taskType,
			String subQuery) throws IntalioException {
		String totalNum = "0";
		try {
			...
			throw new IntalioException("getTotalTasksNumber - TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"'  InvalidParticipantTokenFault_Exception: ", e);
		} catch (InvalidInputMessageFault_Exception e2) {
			throw new IntalioException("getTotalTasksNumber - TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"' InvalidInputMessageFault_Exception: ", e2);
		} catch (Exception e1) {
			throw new IntalioException("getTotalTasksNumber -TaskType: '"+taskType+"' Token: '"+participantToken+"' subQuery: '"+subQuery+"'  Intalio exception: ", e1);
		}
		return totalNum;
	}
	...
	public Task getTask(String taskId, String participantToken) throws IntalioException {
		...
		try {
			...
			throw new IntalioException("getTask - Token: '"+participantToken+"' InvalidParticipantTokenFault_Exception: ", e);
		} catch (InvalidInputMessageFault_Exception e2) {
			throw new IntalioException("getTask - Token: '"+participantToken+"' InvalidInputMessageFault_Exception: ", e2);
		} catch (Exception e1) {
			throw new IntalioException("getTask - Token: '"+participantToken+"' Intalio exception: ", e1);
		}
		return task;
	}

	public List<TaskMetadata> getTaskList(String token) throws IntalioException {
		List<TaskMetadata> taskList = new ArrayList<TaskMetadata>();
		try {

...
public final class MessageUtil {
	...
	static {
		try {
			...
			throw new IllegalStateException(
					"Cannot instantiate DatatypeFactory!", dce);
		}
	}
	 ...
	 */
	public static String formatTaskDateByDay(
			XMLGregorianCalendar xmlGregorianCalendar) {
	 ...
	 * @return formatted date string
	 */
	public static String formatDateByString(
			XMLGregorianCalendar xmlGregorianCalendar, String formatString) {
		return formatDateByString(xmlGregorianCalendar, formatString,

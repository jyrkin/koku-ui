...
public class RegistrationController {
  ...
  @RenderMapping
  public String render(PortletSession session, RenderRequest req, Model model, @ModelAttribute(value = "registration") Registration r, RenderResponse res) {
...
//                    String loginurl = "/portal/login?username="+registration.getUseraccount()+"&password="+registration.getPassword();
...
//                    return "createlogin";
                  ...
                  //Kayttajan tietoja ei loytynyt, joten han ei ole rekisteroitynyt aiemmin
  ...
  public String showErrors2(@Valid @ModelAttribute(value = "userinformation") Userinformation userinformation, BindingResult errors) {
    return "userinformation";
  }
  
  @RenderMapping(params = "action=kokuregistration_createLogin")
  public String createLogin(@ModelAttribute(value = "registration") Registration registration, Model model) throws UnsupportedEncodingException {
    //#TODO# Consider getting "baseURL" as a configurable property
      String loginurl = "/portal/login?username="+ URLEncoder.encode(registration.getUseraccount(), "UTF-8" )+"&password="+ URLEncoder.encode(registration.getPassword(), "UTF-8");
      model.addAttribute("loginurl", loginurl );
    return "createlogin";
  }
  ...
  public void action(
      ...
      @ModelAttribute(value = "registration") Registration r,
      ...
      try {
          ...
          //#TODO# Check these: Needs to be integer -objects. Otherwise fails to go to service.
  ...
  public void saveUserinformationAction(PortletRequest req,
      ActionResponse response,
      SessionStatus sessionStatus,
      @ModelAttribute(value = "userinformation") Userinformation userinfo,
      BindingResult errors){
  ...
  private void handleContactInfo(PortalUserAllType pUser, Registration r) {
    //Traverses through CI objects and gets LAST not blank email and phonenumber values.
    r.setEmail("");
    r.setPhonenumber("");
